...
后续[2026-09-19 窗口批次](../pro-horizon-20260919/README.md)另行比较 3/5/7/9 上限，保留默认七周期并验证 F12 共同周期动作成本方案；该方案在 0.41.3 定版时撤出生产，仅保留离线实验。本页的“只完成诊断”描述本批历史范围；能力席位替换和完整黑暗球/星能消费者差分仍未实施。
