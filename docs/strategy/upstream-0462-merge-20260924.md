...
本文记录 `988d8cd5` 合并阶段的状态。用户随后要求发布，fork 采用 **0.46.3**，官方 `v0.46.2` 标签保持原指向；[玩家说明](../releases/0.46.3-RELEASE_NOTES.md)和[发布索引](../releases/README.md)维护后续交付，下面的开发构建与未发布描述保留其当时语境。
