...
- [官方 0.46.2 合并与知识收尾](upstream-0462-merge-20260924.md)：同步官方单人代码、ServerGC 启动配置、连接元数据门禁和 UI 更新，保留多人手动军师；合并阶段验证、规则和残留候选见记录，后续 fork 0.46.3 交付见[版本索引](../releases/README.md)。
