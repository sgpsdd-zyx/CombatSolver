...
- [多人实验设计：交错行动与手动重算](multiplayer-experiments-20260923/README.md)：2026-09-23 设计稿，区分原生语义、受控闭环和真人校准；规定响应式队友、完整牌组、行动顺序、重算节奏、集群配对与失败/截断口径。附[协议草案](multiplayer-experiments-20260923/protocol.json)，执行器与新实验尚未实现或运行。
