...
- [官方 0.43.2 合并与多人兼容](upstream-0432-merge-20260920.md)：两处上游单人假设的失败基线、多人历史／成长隔离、官方单人对照及未完成的原生适配检查；fork 0.43.5 本地准备版。
...
- [多人当前行为与实施取舍](../multiplayer-advisor.md)：多人功能的现役入口。首批三步优化基于兼容合并 `7160d2f` 完成；当前单人基线已同步为官方 `3f4002bd / 0.43.2`；研究中的旧版本、类型草案与测试数字不覆盖当前实现。
