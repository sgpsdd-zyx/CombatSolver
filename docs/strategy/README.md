...
- [多人伤害归属审视：实验与采用](multiplayer-shared-damage-20260923/implementation.md)：2026-09-23 实验并实施无来源实际伤害按人数参与选路；个人贡献信用保留真实归属。记录五变体、留出根、十四周期负哨兵、原生混毒/Fork/增量、单人和中英验证；队友死亡折价及威胁压力无已观察收益，未采用历史速率预测或 ready 不可撤销假设。
