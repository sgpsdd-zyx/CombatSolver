...
当前 fork 版本为 [0.43.1](releases/0.43.1-RELEASE_NOTES.md)，基于官方 `cccc270 / 0.43.0`，沿用既有多人保路、共同周期比较、有效救援、用药资格和 0.41.3 的三项事实/入口修复。共同周期动作成本调整仍只留离线实验。单人使用官方 `0.43.0` 的搜索政策和自动执行入口；官方版本标签不含 fork 的多人功能。原始研究与历史版本见[策略索引](strategy/README.md#多人研究归档)。多人功能尚未完成真实联机验收；[长线收益诊断](strategy/pro-long-term-20260918/README.md)不改变默认策略。
