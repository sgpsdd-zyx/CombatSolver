...
>
> 发布状态统一见[版本索引](docs/releases/README.md)：官方基线为 `0.46.2`；多人 fork **`0.46.3` 已发布**，来源 `02d1523c`，分支、annotated tag 与 GitHub Release 均已交付。官方 `v0.46.2` 标签保持原指向，`0.44.2` 保留为历史本地准备包；同号日志独立归档。独立[尖塔军师修复工具](tools/SpireAdvisorMultiplayerFix/README.md)另有产物。历史批次、发布授权与证据归[开发笔记](docs/DEVELOPMENT_NOTES.md)和[策略索引](docs/strategy/README.md)，不作为新的操作授权。
