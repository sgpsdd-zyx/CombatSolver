...
>
> 发布状态统一见[版本索引](docs/releases/README.md)：当前合入官方 `0.46.4`，fork `0.46.5` 正在定版；前一公开版为 `0.46.4`。官方标签不移动，同号日志单独归档。独立[尖塔军师修复工具](tools/SpireAdvisorMultiplayerFix/README.md)另有产物。历史批次、发布授权与证据归[开发笔记](docs/DEVELOPMENT_NOTES.md)和[策略索引](docs/strategy/README.md)，不作为新的操作授权。
