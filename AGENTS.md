...
> **2026-09-21 本地准备版 `0.43.6`：** 修复死亡队友重算。完整残留能力与逐玩家 Hook 资格分开保存；死亡清理后停用、治疗复活恢复，随 Fork／生产键／ContinuationStamp 保存。离线原生生命周期与官方单人哨兵通过，见[测试矩阵](docs/TEST_MATRIX.md#0436fork死亡队友重算2026-09-21)；GitHub 发布版仍为 `0.43.5`。
