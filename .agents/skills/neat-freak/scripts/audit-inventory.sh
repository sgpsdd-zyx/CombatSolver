...
find "$PROJECT_ROOT" \
  \( -name .git -o -name .local -o -name .godot -o -name bin -o -name obj -o -name node_modules -o -name .next -o -name dist -o -name build -o -name .venv -o -name venv -o -name __pycache__ -o -name target -o -name vendor -o -name .turbo -o -name .cache \) -prune \
